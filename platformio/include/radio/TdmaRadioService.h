...
public:
  ...
  // (PKT_CMD_SET_TX_POWER — see documentation/Completed_Plans/DYNAMIC_TX_POWER.md).
  ...
  // (nominal Timed standby 35 s > kReliabilityMaxAgeMs 30 s, so it is not a race). The
